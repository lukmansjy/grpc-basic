...
const (
	DataStudent_FindStudentByEmail_FullMethodName = "/student.DataStudent/FindStudentByEmail"
)
...
func (c *dataStudentClient) FindStudentByEmail(ctx context.Context, in *Student, opts ...grpc.CallOption) (*Student, error) {
	out := new(Student)
	err := c.cc.Invoke(ctx, DataStudent_FindStudentByEmail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DataStudent_FindStudentByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataStudent_FindStudentByEmail_FullMethodName,
	}
